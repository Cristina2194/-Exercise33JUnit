...
public class Employee {
	...
	
	{
		...
		if(salesPerMonth>=SALES_FIRST_BONUS_LIMIT && salesPerMonth<SALES_FIRST_BONUS_LIMIT)
		{
			salarySales = 100.0;
		}
		...
		return bruteSalary = (employeeType.contentEquals(EmployeeTypes.salesEmployee.toString()))?SALARY_EMPLOYEE+salarySales+salaryHours:SALARY_MANAGER+salarySales+salaryHours;
